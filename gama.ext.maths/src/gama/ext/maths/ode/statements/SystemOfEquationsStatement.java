/*******************************************************************************************************
 *
 * SystemOfEquationsStatement.java, in gama.ext.maths, is part of the source code of the
...
import gama.ext.maths.ode.statements.SystemOfEquationsStatement.SystemOfEquationsValidator;
import gama.ext.maths.ode.utils.classicalEquations.epidemiology.ClassicalSEIREquations;
import gama.ext.maths.ode.utils.classicalEquations.epidemiology.ClassicalSIEquations;
import gama.ext.maths.ode.utils.classicalEquations.epidemiology.ClassicalSIREquations;
import gama.ext.maths.ode.utils.classicalEquations.epidemiology.ClassicalSIRSEquations;
import gama.ext.maths.ode.utils.classicalEquations.epidemiology.ClassicalSISEquations;
import gama.ext.maths.ode.utils.classicalEquations.populationDynamics.ClassicalLVEquations;
...
import gaml.expressions.variables.AgentVariableExpression;
...
public class SystemOfEquationsStatement extends AbstractStatementSequence implements FirstOrderDifferentialEquations {
	 ...
	 *
	 * @see gaml.statements.AbstractStatementSequence#setChildren(java.util.List)
	 */
	@Override
