/*******************************************************************************************************
 *
 * Unit.java, in gama.core.lang, is part of the source code of the
 ...
 *   <li>{@link msi.gama.lang.gaml.gaml.Unit#getOp <em>Op</em>}</li>
...
public interface Unit extends Expression
{
   ...
   * @see #setOp(String)
   * @see msi.gama.lang.gaml.gaml.GamlPackage#getUnit_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link msi.gama.lang.gaml.gaml.Unit#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
