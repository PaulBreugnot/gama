/*******************************************************************************************************
 *
 * IField.java, in gama.core.kernel, is part of the source code of the
...
public interface IField extends IMatrix<Double>, IDiffusionTarget {
	 ...
	 *
	 * @param scope the scope
	 * @param noData            the value to consider
	 */
	@setter ("no_data")
	 ...
	 *
	 * @param result            an existing array of doubles or null
	 ...
	 *
	 * @param scope the scope
	 * @param loc            a world location (location of an agent, for instance)
