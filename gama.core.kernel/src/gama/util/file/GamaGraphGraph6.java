/*******************************************************************************************************
 *
 * GamaGraphGraph6.java, in gama.core.kernel, is part of the source code of the
...
public class GamaGraphGraph6 extends GamaGraphFile {
	 ...
	 */
	public GamaGraphGraph6(final IScope scope, final String pathName,final ISpecies nodeSpecies, final ISpecies edgeSpecies) {
