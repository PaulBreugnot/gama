/*******************************************************************************************************
 *
 * GamaJsonFile.java, in gama.core.kernel, is part of the source code of the
...
import gama.util.file.json.DeserializationException;
import gama.util.file.json.Jsoner;
