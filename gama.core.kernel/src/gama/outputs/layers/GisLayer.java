/*******************************************************************************************************
 *
 * GisLayer.java, in gama.core.kernel, is part of the source code of the GAMA modeling and simulation platform
 * (v.2.0.0).
 *
...
public class GisLayer extends AbstractLayer {
	 ...
	 */
	public List<IShape> buildGisLayer(final IGraphicsScope scope) throws GamaRuntimeException {
	 ...
	 */
	private GamaShapeFile getShapeFile(final IGraphicsScope scope) {
