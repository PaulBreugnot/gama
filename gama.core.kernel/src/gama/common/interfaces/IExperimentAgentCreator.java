/*******************************************************************************************************
 *
 * IExperimentAgentCreator.java, in gama.core.kernel, is part of the source code of the
...
public interface IExperimentAgentCreator {
	...
	public static class ExperimentAgentDescription implements IExperimentAgentCreator, IGamlDescription {
		 ...
		 * Method create()
		 * 
		 * @see gama.common.interfaces.IExperimentAgentCreator#create(java.lang.Object[])
		 */
		@Override
