/*******************************************************************************************************
 *
 * IMacroAgent.java, in gama.core.kernel, is part of the source code of the GAMA modeling and simulation platform
 * (v.2.0.0).
 *
...
public interface IMacroAgent extends IAgent {
	 ...
	 * @param scope
	 *            the scope
	 * @param oldMicroSpecies
	 *            the old micro species
	 * @param newMicroSpecies
	 *            the new micro species
	 * @return the i list
	 */
