/*******************************************************************************************************
 *
 * IPopulation.java, in gama.core.kernel, is part of the source code of the
...
public interface IPopulation<T extends IAgent>
	 ...
	 * @param isRestored            Indicates that the agents are newly created or they are restored (on a capture or release). If agents
	 *            are restored on a capture or release then don't run their "init" reflex again
	 * @param toBeScheduled            Whether the agent should be immediately scheduled or not
	 * @param sequence            an optional sequence of code to be run after the agent has been scheduled (and then inited). Can be
	 *            null.
	 * @return the i list
	 * @throws GamaRuntimeException the gama runtime exception
	 */
	 ...
	 * Kill members.
	 *
	 * @throws GamaRuntimeException             When the "shape" of host changes, this method is invoked to update the topology.
	 */
