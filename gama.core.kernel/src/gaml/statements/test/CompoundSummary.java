/*******************************************************************************************************
 *
 * CompoundSummary.java, in gama.core.kernel, is part of the source code of the
 ...
 *
 * @author drogoul
 * @param <T>            the type of the sub-summaries
 * @param <S>            the type of the statement represented by this summary
 */
