/*******************************************************************************************************
 *
 * ShapeExecuter.java, in gama.core.kernel, is part of the source code of the GAMA modeling and simulation platform
 * (v.2.0.0).
 *
...
class ShapeExecuter extends DrawExecuter {
	 ...
	 */
	DrawingAttributes computeAttributes(final IGraphicsScope scope, final DrawingData data, final IShape shape) {
	...
	private void addTextures(final IGraphicsScope scope, final DrawingAttributes attributes) {
	 ...
	 * @return the geometry
	 */
	private Geometry addToroidalParts(final IGraphicsScope scope, final Geometry shape) {
	 ...
	 * @return the geometry
	 */
	private Geometry addArrows(final IGraphicsScope scope, final Geometry g1, final Boolean fill) {
