/*******************************************************************************************************
 *
 * GamaGeometryType.java, in gama.core.kernel, is part of the source code of the
...
import static gama.metamodel.shape.IShape.Type.BOX;
import static gama.metamodel.shape.IShape.Type.CONE;
import static gama.metamodel.shape.IShape.Type.CUBE;
import static gama.metamodel.shape.IShape.Type.CYLINDER;
import static gama.metamodel.shape.IShape.Type.LINECYLINDER;
import static gama.metamodel.shape.IShape.Type.PLAN;
import static gama.metamodel.shape.IShape.Type.POLYHEDRON;
import static gama.metamodel.shape.IShape.Type.POLYPLAN;
import static gama.metamodel.shape.IShape.Type.PYRAMID;
import static gama.metamodel.shape.IShape.Type.SPHERE;
import static gama.metamodel.shape.IShape.Type.TEAPOT;
...
public class GamaGeometryType extends GamaType<IShape> {
	...
	public static IShape staticCast(final IScope scope, final Object obj, final Object param, final boolean copy)
		...
		if (obj instanceof IShape) // WARNING TODO Take copy into account
			return (IShape) obj;
