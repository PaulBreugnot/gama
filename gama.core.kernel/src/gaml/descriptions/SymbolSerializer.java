/*******************************************************************************************************
 *
 * SymbolSerializer.java, in gama.core.kernel, is part of the source code of the
...
public class SymbolSerializer<C extends SymbolDescription> implements IKeyword {
	 ...
	 * @param includingBuiltIn the including built in
	 * @return the string
	 * @see msi.gaml.descriptions.IDescriptionSerializer#serialize(gaml.descriptions.IDescription)
	 */
