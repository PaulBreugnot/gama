...
abstract public class PathCommand {
	...
	public PathCommand(final float x, final float y, final int numKnots) {
		this.x = x;
		this.y = y;
		this.numKnots = numKnots;
	}

	public PathCommand(final float x, final float y, final int numKnots, final boolean isRelative) {
		this(x, y, numKnots);
		this.isRelative = isRelative;
	}

	public final int getNumKnotsAdded() {
		return numKnots;
	}
