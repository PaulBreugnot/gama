...
public abstract class AbstractAgent implements IAgent {
	 ...
	 *
	 * @see gama.metamodel.agent.IAgent#getPopulationFor(gaml.species.ISpecies)
	 */
	@Override
	 ...
	 * Method getPopulationFor()
	 *
	 * @see gama.metamodel.agent.IAgent#getPopulationFor(java.lang.String)
	 */
	@Override
	...
	public final Object primTell(final IScope scope) throws GamaRuntimeException {
		final String s = (String) scope.getArg("message", IType.STRING);
		scope.getGui().inform(getName() + " says : ", s);
		return s;
	}
	 ...
	 * Method get()
	 *
	 * @see gama.util.IContainer.Addressable#get(gama.runtime.IScope, java.lang.Object)
	 */
	@Override
	 ...
	 *
	 * @see gama.util.IContainer.Addressable#getFromIndicesList(gama.runtime.IScope, gama.util.IList)
	 */
	@Override
