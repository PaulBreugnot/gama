...
experiment MODAVI type: gui {
	output {			
		display MODAVI type:opengl draw_env:false synchronized: true camera_location:{world.shape.width*1.5, world.shape.height,world.shape.width*4} camera_target:{world.shape.width*1.5, world.shape.height,0}{
