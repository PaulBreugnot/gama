...
global {
	...
	string graph_generator parameter: true init: "Complete" among: ["Random","Scale-free", "Small-world", "Complete", "Distance", "Intersection", "Grid"];
...
experiment Graph type: gui {
	...
	user_command "Create graphs" {
		switch graph_generator {
			...
			match "Scale-free" { ask world { do scale_free(); } }
