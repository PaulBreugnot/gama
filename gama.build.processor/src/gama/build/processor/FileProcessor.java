/*******************************************************************************************************
 *
 * FileProcessor.java, in gama.build.processor, is part of the source code of the
...
public class FileProcessor extends ElementProcessor<file> {
	...
	/**
	 * Builds the binary file constructor.
	 *
	 * @param sb the sb
	...
	protected boolean validateElement(final ProcessorContext context, final Element e) {
		boolean result =
				assertClassExtends(context, true, (TypeElement) e, context.getType("gama.util.file.IGamaFile"));
