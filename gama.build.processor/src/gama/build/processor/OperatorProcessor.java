/*******************************************************************************************************
 *
 * OperatorProcessor.java, in gama.build.processor, is part of the source code of the
...
public class OperatorProcessor extends ElementProcessor<operator> {
	...
	/**
	 * Builds the unary helper call.
	 *
	 * @param sb the sb
	 * @param hasScope the has scope
