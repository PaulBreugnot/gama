/*******************************************************************************************************
 *
 * Constants.java, in gama.build.documentation, is part of the source code of the
...
public class Constants {
	...
	// Commandes
	public final static String CMD_PANDOC = OSUtils.isWindows() ? "C:/pandoc/pandoc.exe" : "/usr/local/bin/pandoc";
	
	/** The Constant CMD_PDFLATEX. */
	public final static String CMD_PDFLATEX =
			OSUtils.isWindows() ? "\"C:/MiKTeX 2.9/miktex/bin/x64/pdflatex.exe\"" : "/Users/benoit/bin/pdflatex";
	...
	//
	public final static String RELEASE_APPLICATION = "gama.release.product";
	...
	public final static String TEST_FOLDER = SRC_FOLDER + File.separator + ".." + File.separator + ".." + File.separator
			+ "gama.models.library" + File.separator + "models" + File.separator + "Tests";
	...
	public final static String XSL_XML2CATALOG_FOLDER =
			INPUT_FOLDER + File.separator + "xsl" + File.separator + "xml2catalog";
	...
	public final static String TOC_FILE =
			INPUT_FOLDER + File.separator + "toc" + File.separator + "toc" + GAMA_VERSION + ".xml";
