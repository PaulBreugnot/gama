...
import static gaml.operators.Containers.collect;
...
import gaml.operators.Containers.ComparableValidator;
...
public class Stats {
	...
	@doc (
			...
			comment = """
					In R moment(c(1, 3, 5, 6, 9, 11, 12, 13), order=3,center=TRUE) is -10.125 and sd(c(1,3,5,6,9,11,12,13)) = 4.407785\
