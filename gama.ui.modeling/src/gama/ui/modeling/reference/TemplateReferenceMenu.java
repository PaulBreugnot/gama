/*******************************************************************************************************
 *
 * TemplateReferenceMenu.java, in gama.ui.modeling, is part of the source code of the
...
public class TemplateReferenceMenu extends GamlReferenceMenu {
	...
	public void editTemplate(final String dataId) {
		...
		if (data == null) {
			data = new TemplatePersistenceData(
					new Template("", "", "gama.core.lang.Gaml.Model", editor.getSelectedText(), true), true, dataId);
		}
	...
	protected void openView() {
		try {
			WorkbenchHelper.getPage().showView("gama.view.templates");
