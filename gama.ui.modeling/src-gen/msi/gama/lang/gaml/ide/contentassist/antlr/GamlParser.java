/*******************************************************************************************************
 *
 * GamlParser.java, in gama.ui.modeling, is part of the source code of the
...
public class GamlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		 ...
		 */
		@Inject
		public NameMappings(final GamlGrammarAccess grammarAccess) {
		...
		private static void init(final ImmutableMap.Builder<AbstractElement, String> builder,
				final GamlGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getEntryAccess().getAlternatives(), "rule__Entry__Alternatives");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getNameAlternatives_2_0(),
					"rule__HeadlessExperiment__NameAlternatives_2_0");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getAlternatives_5(),
			...
			builder.put(grammarAccess.getS_ExperimentAccess().getNameAlternatives_2_0(),
					"rule__S_Experiment__NameAlternatives_2_0");
			builder.put(grammarAccess.getS_ExperimentAccess().getAlternatives_4(),
			...
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getAlternatives_4(),
			...
			builder.put(grammarAccess.getS_IfAccess().getElseAlternatives_4_1_0(),
			...
			builder.put(grammarAccess.getS_DefinitionAccess().getNameAlternatives_2_0(),
					"rule__S_Definition__NameAlternatives_2_0");
			builder.put(grammarAccess.getS_DefinitionAccess().getAlternatives_5(),
			...
			builder.put(grammarAccess.getS_EquationAccess().getExprAlternatives_0_0(),
			...
			builder.put(grammarAccess.getS_DisplayAccess().getNameAlternatives_2_0(),
					"rule__S_Display__NameAlternatives_2_0");
			builder.put(grammarAccess.getDisplayStatementAccess().getAlternatives(),
					"rule__DisplayStatement__Alternatives");
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getAlternatives_3(),
			...
			builder.put(grammarAccess.get_1Expr_Facets_BlockOrEnd_KeyAccess().getAlternatives(),
			...
			builder.put(grammarAccess.get_VarOrConstKeyAccess().getAlternatives(),
			...
			builder.put(grammarAccess.get_AssignmentKeyAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getDefinitionFacetKeyAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getSpecialFacetKeyAccess().getAlternatives(),
					"rule__SpecialFacetKey__Alternatives");
			builder.put(grammarAccess.getActionFacetKeyAccess().getAlternatives(),
					"rule__ActionFacetKey__Alternatives");
			builder.put(grammarAccess.getClassicFacetAccess().getAlternatives_0(),
					"rule__ClassicFacet__Alternatives_0");
			builder.put(grammarAccess.getDefinitionFacetAccess().getNameAlternatives_1_0(),
					"rule__DefinitionFacet__NameAlternatives_1_0");
			builder.put(grammarAccess.getFunctionFacetAccess().getAlternatives_1(),
			...
			builder.put(grammarAccess.getBinaryOperatorAccess().getAlternatives(),
					"rule__BinaryOperator__Alternatives");
			builder.put(grammarAccess.getArgumentPairAccess().getAlternatives_0_0(),
					"rule__ArgumentPair__Alternatives_0_0");
			builder.put(grammarAccess.getArgumentPairAccess().getOpAlternatives_0_0_1_0_0(),
			...
			builder.put(grammarAccess.getComparisonAccess().getOpAlternatives_1_0_1_0(),
					"rule__Comparison__OpAlternatives_1_0_1_0");
			builder.put(grammarAccess.getAdditionAccess().getOpAlternatives_1_0_1_0(),
					"rule__Addition__OpAlternatives_1_0_1_0");
			builder.put(grammarAccess.getMultiplicationAccess().getOpAlternatives_1_0_1_0(),
					"rule__Multiplication__OpAlternatives_1_0_1_0");
			builder.put(grammarAccess.getUnitAccess().getOpAlternatives_1_0_1_0(),
			...
			builder.put(grammarAccess.getUnaryAccess().getOpAlternatives_1_1_0_0_0(),
					"rule__Unary__OpAlternatives_1_1_0_0_0");
			builder.put(grammarAccess.getUnaryAccess().getOpAlternatives_1_1_1_0_0(),
			...
			builder.put(grammarAccess.getAccessAccess().getRightAlternatives_1_1_1_1_0(),
			...
			builder.put(grammarAccess.getExpressionListAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getParameterAccess().getBuiltInFacetKeyAlternatives_1_0_0(),
			...
			builder.put(grammarAccess.getGamlDefinitionAccess().getAlternatives(),
					"rule__GamlDefinition__Alternatives");
			builder.put(grammarAccess.getEquationDefinitionAccess().getAlternatives(),
					"rule__EquationDefinition__Alternatives");
			builder.put(grammarAccess.getTypeDefinitionAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getVarDefinitionAccess().getAlternatives_1(),
					"rule__VarDefinition__Alternatives_1");
			builder.put(grammarAccess.getActionDefinitionAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getTerminalExpressionAccess().getAlternatives(),
			...
			builder.put(grammarAccess.getHeadlessExperimentAccess().getGroup_3(),
			...
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getGroup(),
			...
			builder.put(grammarAccess.getS_DirectAssignmentAccess().getGroup_0(),
			...
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getGroup(),
			...
			builder.put(grammarAccess.getArgumentDefinitionAccess().getGroup_2(),
			...
			builder.put(grammarAccess.getActionFakeDefinitionAccess().getGroup(),
			...
			builder.put(grammarAccess.getEquationFakeDefinitionAccess().getGroup(),
					"rule__EquationFakeDefinition__Group__0");
			builder.put(grammarAccess.getTerminalExpressionAccess().getGroup_1(),
					"rule__TerminalExpression__Group_1__0");
			builder.put(grammarAccess.getTerminalExpressionAccess().getGroup_2(),
					"rule__TerminalExpression__Group_2__0");
			builder.put(grammarAccess.getTerminalExpressionAccess().getGroup_3(),
					"rule__TerminalExpression__Group_3__0");
			builder.put(grammarAccess.getTerminalExpressionAccess().getGroup_4(),
					"rule__TerminalExpression__Group_4__0");
			builder.put(grammarAccess.getStandaloneBlockAccess().getBlockAssignment_1(),
					"rule__StandaloneBlock__BlockAssignment_1");
			builder.put(grammarAccess.getStringEvaluatorAccess().getTotoAssignment_0(),
					"rule__StringEvaluator__TotoAssignment_0");
			builder.put(grammarAccess.getStringEvaluatorAccess().getExprAssignment_2(),
			...
			builder.put(grammarAccess.getModelBlockAccess().getStatementsAssignment_1(),
			...
			builder.put(grammarAccess.getExperimentFileStructureAccess().getExpAssignment(),
					"rule__ExperimentFileStructure__ExpAssignment");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getKeyAssignment_0(),
					"rule__HeadlessExperiment__KeyAssignment_0");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getFirstFacetAssignment_1(),
					"rule__HeadlessExperiment__FirstFacetAssignment_1");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getNameAssignment_2(),
					"rule__HeadlessExperiment__NameAssignment_2");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getImportURIAssignment_3_1(),
					"rule__HeadlessExperiment__ImportURIAssignment_3_1");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getFacetsAssignment_4(),
					"rule__HeadlessExperiment__FacetsAssignment_4");
			builder.put(grammarAccess.getHeadlessExperimentAccess().getBlockAssignment_5_0(),
			...
			builder.put(grammarAccess.getS_GlobalAccess().getFacetsAssignment_1(),
					"rule__S_Global__FacetsAssignment_1");
			builder.put(grammarAccess.getS_GlobalAccess().getBlockAssignment_2_0(),
			...
			builder.put(grammarAccess.getS_SpeciesAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_SpeciesAccess().getFacetsAssignment_3(),
					"rule__S_Species__FacetsAssignment_3");
			builder.put(grammarAccess.getS_SpeciesAccess().getBlockAssignment_4_0(),
					"rule__S_Species__BlockAssignment_4_0");
			builder.put(grammarAccess.getS_ExperimentAccess().getKeyAssignment_0(),
					"rule__S_Experiment__KeyAssignment_0");
			builder.put(grammarAccess.getS_ExperimentAccess().getFirstFacetAssignment_1(),
					"rule__S_Experiment__FirstFacetAssignment_1");
			builder.put(grammarAccess.getS_ExperimentAccess().getNameAssignment_2(),
					"rule__S_Experiment__NameAssignment_2");
			builder.put(grammarAccess.getS_ExperimentAccess().getFacetsAssignment_3(),
					"rule__S_Experiment__FacetsAssignment_3");
			builder.put(grammarAccess.getS_ExperimentAccess().getBlockAssignment_4_0(),
					"rule__S_Experiment__BlockAssignment_4_0");
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getKeyAssignment_0(),
					"rule__S_1Expr_Facets_BlockOrEnd__KeyAssignment_0");
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getFirstFacetAssignment_1(),
					"rule__S_1Expr_Facets_BlockOrEnd__FirstFacetAssignment_1");
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getExprAssignment_2(),
					"rule__S_1Expr_Facets_BlockOrEnd__ExprAssignment_2");
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getFacetsAssignment_3(),
					"rule__S_1Expr_Facets_BlockOrEnd__FacetsAssignment_3");
			builder.put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getBlockAssignment_4_0(),
			...
			builder.put(grammarAccess.getS_DoAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_IfAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_OtherAccess().getBlockAssignment_2_0(),
			...
			builder.put(grammarAccess.getS_ReturnAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_ReflexAccess().getFirstFacetAssignment_1_0(),
					"rule__S_Reflex__FirstFacetAssignment_1_0");
			builder.put(grammarAccess.getS_ReflexAccess().getNameAssignment_1_1(),
					"rule__S_Reflex__NameAssignment_1_1");
			builder.put(grammarAccess.getS_ReflexAccess().getExprAssignment_2_2(),
			...
			builder.put(grammarAccess.getS_DefinitionAccess().getTkeyAssignment_0(),
					"rule__S_Definition__TkeyAssignment_0");
			builder.put(grammarAccess.getS_DefinitionAccess().getFirstFacetAssignment_1(),
					"rule__S_Definition__FirstFacetAssignment_1");
			builder.put(grammarAccess.getS_DefinitionAccess().getNameAssignment_2(),
					"rule__S_Definition__NameAssignment_2");
			builder.put(grammarAccess.getS_DefinitionAccess().getArgsAssignment_3_1(),
					"rule__S_Definition__ArgsAssignment_3_1");
			builder.put(grammarAccess.getS_DefinitionAccess().getFacetsAssignment_4(),
					"rule__S_Definition__FacetsAssignment_4");
			builder.put(grammarAccess.getS_DefinitionAccess().getBlockAssignment_5_0(),
			...
			builder.put(grammarAccess.getS_ActionAccess().getFirstFacetAssignment_2(),
			...
			builder.put(grammarAccess.getS_ActionAccess().getArgsAssignment_4_1(),
					"rule__S_Action__ArgsAssignment_4_1");
			builder.put(grammarAccess.getS_ActionAccess().getFacetsAssignment_5(),
					"rule__S_Action__FacetsAssignment_5");
			builder.put(grammarAccess.getS_ActionAccess().getBlockAssignment_6_0(),
			...
			builder.put(grammarAccess.getS_VarAccess().getFirstFacetAssignment_2(),
			...
			builder.put(grammarAccess.getS_DirectAssignmentAccess().getExprAssignment_0_0(),
					"rule__S_DirectAssignment__ExprAssignment_0_0");
			builder.put(grammarAccess.getS_DirectAssignmentAccess().getKeyAssignment_0_1(),
					"rule__S_DirectAssignment__KeyAssignment_0_1");
			builder.put(grammarAccess.getS_DirectAssignmentAccess().getValueAssignment_0_2(),
					"rule__S_DirectAssignment__ValueAssignment_0_2");
			builder.put(grammarAccess.getS_DirectAssignmentAccess().getFacetsAssignment_0_3(),
			...
			builder.put(grammarAccess.getS_EquationsAccess().getKeyAssignment_0(),
					"rule__S_Equations__KeyAssignment_0");
			builder.put(grammarAccess.getS_EquationsAccess().getNameAssignment_1(),
					"rule__S_Equations__NameAssignment_1");
			builder.put(grammarAccess.getS_EquationsAccess().getFacetsAssignment_2(),
					"rule__S_Equations__FacetsAssignment_2");
			builder.put(grammarAccess.getS_EquationsAccess().getEquationsAssignment_3_0_1_0(),
					"rule__S_Equations__EquationsAssignment_3_0_1_0");
			builder.put(grammarAccess.getS_EquationAccess().getExprAssignment_0(),
			...
			builder.put(grammarAccess.getS_EquationAccess().getValueAssignment_2(),
			...
			builder.put(grammarAccess.getS_SolveAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_SolveAccess().getBlockAssignment_4_0(),
			...
			builder.put(grammarAccess.getS_DisplayAccess().getFirstFacetAssignment_1(),
			...
			builder.put(grammarAccess.getS_DisplayAccess().getFacetsAssignment_3(),
					"rule__S_Display__FacetsAssignment_3");
			builder.put(grammarAccess.getS_DisplayAccess().getBlockAssignment_4(),
					"rule__S_Display__BlockAssignment_4");
			builder.put(grammarAccess.getDisplayBlockAccess().getStatementsAssignment_2(),
					"rule__DisplayBlock__StatementsAssignment_2");
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getKeyAssignment_0(),
					"rule__SpeciesOrGridDisplayStatement__KeyAssignment_0");
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getExprAssignment_1(),
					"rule__SpeciesOrGridDisplayStatement__ExprAssignment_1");
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getFacetsAssignment_2(),
					"rule__SpeciesOrGridDisplayStatement__FacetsAssignment_2");
			builder.put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getBlockAssignment_3_0(),
					"rule__SpeciesOrGridDisplayStatement__BlockAssignment_3_0");
			builder.put(grammarAccess.getActionArgumentsAccess().getArgsAssignment_0(),
					"rule__ActionArguments__ArgsAssignment_0");
			builder.put(grammarAccess.getActionArgumentsAccess().getArgsAssignment_1_1(),
					"rule__ActionArguments__ArgsAssignment_1_1");
			builder.put(grammarAccess.getArgumentDefinitionAccess().getTypeAssignment_0(),
					"rule__ArgumentDefinition__TypeAssignment_0");
			builder.put(grammarAccess.getArgumentDefinitionAccess().getNameAssignment_1(),
					"rule__ArgumentDefinition__NameAssignment_1");
			builder.put(grammarAccess.getArgumentDefinitionAccess().getDefaultAssignment_2_1(),
					"rule__ArgumentDefinition__DefaultAssignment_2_1");
			builder.put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_0(),
					"rule__ClassicFacet__KeyAssignment_0_0");
			builder.put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_1(),
					"rule__ClassicFacet__KeyAssignment_0_1");
			builder.put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_2(),
					"rule__ClassicFacet__KeyAssignment_0_2");
			builder.put(grammarAccess.getClassicFacetAccess().getExprAssignment_1(),
					"rule__ClassicFacet__ExprAssignment_1");
			builder.put(grammarAccess.getDefinitionFacetAccess().getKeyAssignment_0(),
					"rule__DefinitionFacet__KeyAssignment_0");
			builder.put(grammarAccess.getDefinitionFacetAccess().getNameAssignment_1(),
					"rule__DefinitionFacet__NameAssignment_1");
			builder.put(grammarAccess.getFunctionFacetAccess().getKeyAssignment_0(),
					"rule__FunctionFacet__KeyAssignment_0");
			builder.put(grammarAccess.getFunctionFacetAccess().getExprAssignment_1_0_0(),
					"rule__FunctionFacet__ExprAssignment_1_0_0");
			builder.put(grammarAccess.getFunctionFacetAccess().getExprAssignment_1_1_1(),
			...
			builder.put(grammarAccess.getTypeFacetAccess().getExprAssignment_1_0_0(),
					"rule__TypeFacet__ExprAssignment_1_0_0");
			builder.put(grammarAccess.getTypeFacetAccess().getExprAssignment_1_1(),
					"rule__TypeFacet__ExprAssignment_1_1");
			builder.put(grammarAccess.getActionFacetAccess().getKeyAssignment_0(),
					"rule__ActionFacet__KeyAssignment_0");
			builder.put(grammarAccess.getActionFacetAccess().getExprAssignment_1_0(),
					"rule__ActionFacet__ExprAssignment_1_0");
			builder.put(grammarAccess.getActionFacetAccess().getBlockAssignment_1_1(),
			...
			builder.put(grammarAccess.getBlockAccess().getStatementsAssignment_2_0(),
					"rule__Block__StatementsAssignment_2_0");
			builder.put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_0_0(),
					"rule__ArgumentPair__OpAssignment_0_0_0_0");
			builder.put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_1_0(),
					"rule__ArgumentPair__OpAssignment_0_0_1_0");
			builder.put(grammarAccess.getArgumentPairAccess().getRightAssignment_1(),
			...
			builder.put(grammarAccess.getCastAccess().getRightAssignment_1_1_1_1(),
					"rule__Cast__RightAssignment_1_1_1_1");
			builder.put(grammarAccess.getComparisonAccess().getOpAssignment_1_0_1(),
					"rule__Comparison__OpAssignment_1_0_1");
			builder.put(grammarAccess.getComparisonAccess().getRightAssignment_1_1(),
					"rule__Comparison__RightAssignment_1_1");
			builder.put(grammarAccess.getAdditionAccess().getOpAssignment_1_0_1(),
					"rule__Addition__OpAssignment_1_0_1");
			builder.put(grammarAccess.getAdditionAccess().getRightAssignment_1_1(),
					"rule__Addition__RightAssignment_1_1");
			builder.put(grammarAccess.getMultiplicationAccess().getOpAssignment_1_0_1(),
					"rule__Multiplication__OpAssignment_1_0_1");
			builder.put(grammarAccess.getMultiplicationAccess().getRightAssignment_1_1(),
					"rule__Multiplication__RightAssignment_1_1");
			builder.put(grammarAccess.getExponentiationAccess().getOpAssignment_1_0_1(),
					"rule__Exponentiation__OpAssignment_1_0_1");
			builder.put(grammarAccess.getExponentiationAccess().getRightAssignment_1_1(),
			...
			builder.put(grammarAccess.getUnaryAccess().getRightAssignment_1_1_0_1(),
			...
			builder.put(grammarAccess.getUnaryAccess().getRightAssignment_1_1_1_1(),
					"rule__Unary__RightAssignment_1_1_1_1");
			builder.put(grammarAccess.getAccessAccess().getOpAssignment_1_1_0_0(),
					"rule__Access__OpAssignment_1_1_0_0");
			builder.put(grammarAccess.getAccessAccess().getRightAssignment_1_1_0_1(),
					"rule__Access__RightAssignment_1_1_0_1");
			builder.put(grammarAccess.getAccessAccess().getOpAssignment_1_1_1_0(),
					"rule__Access__OpAssignment_1_1_1_0");
			builder.put(grammarAccess.getAccessAccess().getRightAssignment_1_1_1_1(),
					"rule__Access__RightAssignment_1_1_1_1");
			builder.put(grammarAccess.getPrimaryAccess().getExprsAssignment_3_2(),
			...
			builder.put(grammarAccess.getPrimaryAccess().getRightAssignment_4_4(),
			...
			builder.put(grammarAccess.getExpressionListAccess().getExprsAssignment_0_0(),
					"rule__ExpressionList__ExprsAssignment_0_0");
			builder.put(grammarAccess.getExpressionListAccess().getExprsAssignment_0_1_1(),
					"rule__ExpressionList__ExprsAssignment_0_1_1");
			builder.put(grammarAccess.getExpressionListAccess().getExprsAssignment_1_0(),
					"rule__ExpressionList__ExprsAssignment_1_0");
			builder.put(grammarAccess.getExpressionListAccess().getExprsAssignment_1_1_1(),
					"rule__ExpressionList__ExprsAssignment_1_1_1");
			builder.put(grammarAccess.getParameterAccess().getBuiltInFacetKeyAssignment_1_0(),
					"rule__Parameter__BuiltInFacetKeyAssignment_1_0");
			builder.put(grammarAccess.getParameterAccess().getLeftAssignment_1_1_0(),
					"rule__Parameter__LeftAssignment_1_1_0");
			builder.put(grammarAccess.getParameterAccess().getRightAssignment_2(),
			...
			builder.put(grammarAccess.getVariableRefAccess().getRefAssignment_1(),
					"rule__VariableRef__RefAssignment_1");
			builder.put(grammarAccess.getTypeRefAccess().getRefAssignment_0_1_0(),
					"rule__TypeRef__RefAssignment_0_1_0");
			builder.put(grammarAccess.getTypeRefAccess().getParameterAssignment_0_1_1(),
					"rule__TypeRef__ParameterAssignment_0_1_1");
			builder.put(grammarAccess.getTypeRefAccess().getParameterAssignment_1_1_1(),
			...
			builder.put(grammarAccess.getTypeInfoAccess().getSecondAssignment_2_1(),
			...
			builder.put(grammarAccess.getEquationRefAccess().getRefAssignment_1(),
					"rule__EquationRef__RefAssignment_1");
			builder.put(grammarAccess.getUnitFakeDefinitionAccess().getNameAssignment_1(),
					"rule__UnitFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getTypeFakeDefinitionAccess().getNameAssignment_1(),
					"rule__TypeFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getActionFakeDefinitionAccess().getNameAssignment_1(),
					"rule__ActionFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getSkillFakeDefinitionAccess().getNameAssignment_1(),
					"rule__SkillFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getVarFakeDefinitionAccess().getNameAssignment_1(),
					"rule__VarFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getEquationFakeDefinitionAccess().getNameAssignment_1(),
					"rule__EquationFakeDefinition__NameAssignment_1");
			builder.put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_1_1(),
					"rule__TerminalExpression__OpAssignment_1_1");
			builder.put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_2_1(),
					"rule__TerminalExpression__OpAssignment_2_1");
			builder.put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_3_1(),
					"rule__TerminalExpression__OpAssignment_3_1");
			builder.put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_4_1(),
	...
	/** The grammar access. */
	@Inject private GamlGrammarAccess grammarAccess;
	 ...
	 */
	public void setNameMappings(final NameMappings nameMappings) {
