/*******************************************************************************************************
 *
 * Firm.java, in gama.ext.libs, is part of the source code of the
...
public class Firm implements Cloneable
{
     ...
     *
     * @param firmName the new firm name
     */
     ...
     *
     * @param firmName     Objects of the following type are allowed in the list: {@link Firm.FirmName}
     * @return     <tt>true</tt> (as general contract of <tt>Collection.add</tt>).
     */
     ...
     *
     * @param department     Objects of the following type are allowed in the list: {@link Department}
     * @return     <tt>true</tt> (as general contract of <tt>Collection.add</tt>).
     */
     ...
     * fluent setter.
     *
     * @param firmName     required parameter
     * @return the firm
