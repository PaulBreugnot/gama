    ...
    implements Cloneable
{
    ...
    /**
     * Creates a new instance of {@link gama.ext.libs.kml.Link} and set it to url.
     * 
    ...
    /**
     * Creates a new instance of {@link gama.ext.libs.kml.Link} and set it to link.
     * 
     * This method is a short version for:
     * <code>
     * Link link = new Link();
    ...
    @Obvious
    @Override
    public NetworkLink withAtomLink(final gama.ext.libs.kml.atom.Link atomLink) {
    ...
    public NetworkLink clone() {
        ...
        copy.url = ((url == null)?null:((gama.ext.libs.kml.Link) url.clone()));
        copy.link = ((link == null)?null:((gama.ext.libs.kml.Link) link.clone()));
