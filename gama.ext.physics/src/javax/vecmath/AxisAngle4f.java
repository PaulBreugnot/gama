/*******************************************************************************************************
 *
 * AxisAngle4f.java, in gama.ext.physics, is part of the source code of the
...
public class AxisAngle4f implements java.io.Serializable, Cloneable {
	...
	/**
	 * Returns a hash code value based on the data values in this object. Two different AxisAngle4f objects with
	 * identical data values (i.e., AxisAngle4f.equals returns true) will return the same hash code value. Two objects
