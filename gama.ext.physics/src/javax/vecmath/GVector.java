...
public class GVector implements java.io.Serializable, Cloneable {
	...
	/**
	 * Constructs a new GVector from the specified array elements. The length of this GVector is set to the length of
	 * the specified array. The array elements are copied into this new GVector.
	 *
	 * @param vector
	...
	/**
	 * Constructs a new GVector of the specified length and initializes it by copying the specified number of elements
	 * from the specified array. The array must contain at least <code>length</code> elements (i.e.,
	 * <code>vector.length</code> &ge; <code>length</code>. The length of this new GVector is set to the specified
	 * length.
	 *
	 * @param vector
	...
	public final void normalize(final GVector v1) {
		...
		if (length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector0"));
	...
	public final void scale(final double s, final GVector v1) {
		int i;
		if (length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector1"));
	...
	public final void scaleAdd(final double s, final GVector v1, final GVector v2) {
		...
		if (v2.length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector2"));

		if (length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector3"));
	...
	public final void add(final GVector vector) {
		...
		if (length != vector.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector4"));
	...
	public final void add(final GVector vector1, final GVector vector2) {
		...
		if (vector1.length != vector2.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector5"));

		if (length != vector1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector6"));
	...
	public final void sub(final GVector vector) {
		...
		if (length != vector.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector7"));
	...
	public final void sub(final GVector vector1, final GVector vector2) {
		...
		if (vector1.length != vector2.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector8"));

		if (length != vector1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector9"));
	...
	public final void mul(final GMatrix m1, final GVector v1) {
		if (m1.getNumCol() != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector10"));

		if (length != m1.getNumRow()) throw new MismatchedSizeException(VecMathI18N.getString("GVector11"));
	...
	/**
	 * Multiplies the transpose of vector v1 (ie, v1 becomes a row vector with respect to the multiplication) times
	...
	public final void mul(final GVector v1, final GMatrix m1) {
		...
		if (length != m1.getNumCol()) throw new MismatchedSizeException(VecMathI18N.getString("GVector13"));
	...
	/**
	 * Changes the size of this vector dynamically. If the size is increased no data values will be lost. If the size is
	 * decreased, only those data values whose vector positions were eliminated will be lost.
	 *
	 * @param length
	...
	/**
	 * Sets the value of this vector to the values found in the array parameter. The array should be at least equal in
	...
	/**
	 * Returns a hash code value based on the data values in this object. Two different GVector objects with identical
	 * data values (i.e., GVector.equals returns true) will return the same hash number. Two GVector objects with
	...
	/**
	 * Returns true if all of the data members of GVector vector1 are equal to the corresponding data members in this
	 * GVector.
	 *
	 * @param vector1
	...
	public final double dot(final GVector v1) {
		if (length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector14"));
	...
	/**
	 * Solves for x in Ax = b, where x is this vector (nx1), A is mxn, b is mx1, and A = U*W*transpose(V); U,W,V must be
	 * precomputed and can be found by taking the singular value decomposition (SVD) of A using the method SVD found in
	 * the GMatrix class.
	 *
	 * @param U
	...
	/**
	 * LU Decomposition Back Solve; this method takes the LU matrix and the permutation vector produced by the GMatrix
	 * method LUD and solves the equation (LU)*x = b by placing the solution vector x into this vector. This vector
	...
	public final void LUDBackSolve(final GMatrix LU, final GVector b, final GVector permutation) {
		...
		if (LU.nRow != b.getSize()) throw new MismatchedSizeException(VecMathI18N.getString("GVector16"));

		if (LU.nRow != permutation.getSize()) throw new MismatchedSizeException(VecMathI18N.getString("GVector24"));

		if (LU.nRow != LU.nCol) throw new MismatchedSizeException(VecMathI18N.getString("GVector25"));
	...
	/**
	 * Returns the (n-space) angle in radians between this vector and the vector parameter; the return value is
	...
	public final void interpolate(final GVector v1, final GVector v2, final double alpha) {
		if (v2.length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector20"));

		if (length != v1.length) throw new MismatchedSizeException(VecMathI18N.getString("GVector21"));
	...
	/**
	 * Linearly interpolates between this vector and vector v1 and places the result into this tuple: this =
	 * (1-alpha)*this + alpha*v1.
	 *
	 * @param v1
	 *            the first vector
	 * @param alpha
	...
	public final void interpolate(final GVector v1, final double alpha) {
		if (v1.length != length) throw new MismatchedSizeException(VecMathI18N.getString("GVector22"));
