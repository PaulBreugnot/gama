/*******************************************************************************************************
 *
 * Matrix3f.java, in gama.ext.physics, is part of the source code of the
...
public class Matrix3f implements java.io.Serializable, Cloneable {
	...
	/** The Constant EPS. */
	/*
	 * double[] tmp = new double[9]; // scratch matrix double[] tmp_rot = new double[9]; // scratch matrix double[]
	 * tmp_scale = new double[3]; // scratch matrix
	 */
	...
	/**
	 * Sets the values in this Matrix3f equal to the row-major array parameter (ie, the first three elements of the
	...
	/**
	 * Returns true if all of the data members of Matrix3f m1 are equal to the corresponding data members in this
	 * Matrix3f.
	 *
	 * @param m1
	...
	/**
	 * Returns true if the Object o1 is of type Matrix3f and all of the data members of o1 are equal to the
	...
	public final void transform(final Tuple3f t, final Tuple3f result) {
		...
		result.x = m00 * t.x + m01 * t.y + m02 * t.z;
		result.y = m10 * t.x + m11 * t.y + m12 * t.z;
	}
