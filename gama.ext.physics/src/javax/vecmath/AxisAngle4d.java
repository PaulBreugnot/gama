...
public class AxisAngle4d implements java.io.Serializable, Cloneable {
	 ...
	 * no rotational component, the value of this AxisAngle4d is set to an angle of 0 about an axis of (0,1,0).
	 *
	 * @param m1
	 *            the matrix4f
	 */
	 ...
	 * quaternion has no rotational component, the value of this AxisAngle4d is set to an angle of 0 about an axis of
	 * (0,1,0).
	 *
	 * @param q1
	 *            the Quat4f
	...
	/**
	 * Returns true if the Object o1 is of type AxisAngle4d and all of the data members of o1 are equal to the
	...
	/**
	 * Returns a hash code value based on the data values in this object. Two different AxisAngle4d objects with
	 * identical data values (i.e., AxisAngle4d.equals returns true) will return the same hash code value. Two objects
