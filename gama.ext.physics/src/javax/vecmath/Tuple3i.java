/*******************************************************************************************************
 *
 * Tuple3i.java, in gama.ext.physics, is part of the source code of the
...
public abstract class Tuple3i implements java.io.Serializable, Cloneable {
	...
	/**
	 * Returns a hash code value based on the data values in this object. Two different Tuple3i objects with identical
	 * data values (i.e., Tuple3i.equals returns true) will return the same hash code value. Two objects with different
