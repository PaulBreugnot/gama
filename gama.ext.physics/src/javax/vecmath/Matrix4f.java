...
public class Matrix4f implements java.io.Serializable, Cloneable {
	...
	/**
	 * Constructs and initializes a Matrix4f from the quaternion, translation, and scale values; the scale is applied
	...
	/**
	 * Performs an element-by-element subtraction of matrix m2 from matrix m1 and places the result into matrix this
	 * (this = m2 - m1).
	 *
	 * @param m1
	 *            the first matrix
	...
	final void invertGeneral(final Matrix4f m1) {
		...
		if (!luDecomposition(temp, row_perm)) // Matrix has no inverse
	...
	static boolean luDecomposition(final double[] matrix0, final int[] row_perm) {
...

		{
			...
			for (j = 0; j < 4; j++) {
				...
				if (imax < 0) throw new RuntimeException(VecMathI18N.getString("Matrix4f13"));
	...
	public final void mul(final Matrix4f m1) {
		float m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33; // vars for temp result
																								// matrix
	...
	public final void mul(final Matrix4f m1, final Matrix4f m2) {
		if (this != m1 && this != m2) {
			...
			float m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33; // vars for temp
																									// result matrix
	...
	/**
	 * Returns true if all of the data members of Matrix4f m1 are equal to the corresponding data members in this
	 * Matrix4f.
	 *
	 * @param m1
	...
	/**
	 * Returns true if the Object t1 is of type Matrix4f and all of the data members of t1 are equal to the
	...
	/**
	 * Transforms the point parameter with this Matrix4f and places the result back into point. The fourth element of
	 * the point input paramter is assumed to be one.
	 *
	 * @param point
	 *            the input point to be transformed.
	 */
