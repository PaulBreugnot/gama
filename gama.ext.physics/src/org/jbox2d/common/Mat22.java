/*******************************************************************************************************
 *
 * Mat22.java, in gama.ext.physics, is part of the source code of the
...
public class Mat22 implements Serializable {
   ...
   *
   * @param exx the exx
   * @param col2x the col 2 x
   * @param exy the exy
   * @param col2y the col 2 y
   */
  ...
  /**
   * Creates the rotational transform.
   *
