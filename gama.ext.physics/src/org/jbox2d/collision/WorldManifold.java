/*******************************************************************************************************
 *
 * WorldManifold.java, in gama.ext.physics, is part of the source code of the
...
public class WorldManifold {
  ...
  /**
   * Instantiates a new world manifold.
   */
   ...
   * @param xfA the xf A
   * @param radiusA the radius A
   * @param xfB the xf B
   * @param radiusB the radius B
   */
