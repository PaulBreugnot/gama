/*******************************************************************************************************
 *
 * RaycastVehicle.java, in gama.ext.physics, is part of the source code of the
...
public class RaycastVehicle extends TypedConstraint {
	 ...
	 *
	 * @param connectionPointCS the connection point CS
	 * @param wheelDirectionCS0 the wheel direction CS 0
	 * @param wheelAxleCS the wheel axle CS
	 ...
	 *
	 * @return the current speed km hour
	 */
