/*******************************************************************************************************
 *
 * TriangleIndexVertexArray.java, in gama.ext.physics, is part of the source code of the
...
public class TriangleIndexVertexArray extends StridingMeshInterface {
	 ...
	 *
	 * @param numTriangles the num triangles
	 * @param triangleIndexBase the triangle index base
	 * @param triangleIndexStride the triangle index stride
	 * @param numVertices the num vertices
	 * @param vertexBase the vertex base
