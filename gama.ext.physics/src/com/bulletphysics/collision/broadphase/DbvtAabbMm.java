/*******************************************************************************************************
 *
 * DbvtAabbMm.java, in gama.ext.physics, is part of the source code of the
...
public class DbvtAabbMm {
	 ...
	 * @param d the d
	 * @param smi the smi
	 * @param smi_idx the smi idx
	 * @param smx the smx
	 * @param smx_idx the smx idx
	 */
