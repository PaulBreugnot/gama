/*******************************************************************************************************
 *
 * CollisionWorld.java, in gama.ext.physics, is part of the source code of the
...
public class CollisionWorld {
	 ...
	 *
	 * @param castShape the cast shape
	 * @param convexFromTrans the convex from trans
	 * @param convexToTrans the convex to trans
	 * @param collisionObject the collision object
	 * @param collisionShape the collision shape
	 * @param colObjWorldTransform the col obj world transform
	 * @param resultCallback the result callback
