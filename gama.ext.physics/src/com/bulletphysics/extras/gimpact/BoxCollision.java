/*******************************************************************************************************
 *
 * BoxCollision.java, in gama.ext.physics, is part of the source code of the
...
public class BoxCollision {
	...
	public static class AABB {
		 ...
		 *
		 * @param box the box
		 * @param transcache the transcache
		 * @param fulltest the fulltest
		 * @return true, if successful
		 */
		 ...
		 * @param p2 the p 2
		 * @param p3 the p 3
		 * @param triangle_plane the triangle plane
		 * @return true, if successful
		 */
