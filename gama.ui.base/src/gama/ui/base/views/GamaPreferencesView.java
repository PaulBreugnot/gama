/*********************************************************************************************
 *
 * 'GamaPreferencesView.java, in plugin gama.ui.base, is part of the source code of the GAMA modeling and
...
import static gama.ui.base.resources.IGamaColors.DARK_GRAY;
...
public class GamaPreferencesView {
	...
	private void buildButtons() {
		...
		buttonOK.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				if (restartRequired) {
					...
					final var restart = Dialogs.confirm("Restart GAMA",
		...
		buttonRevert.addSelectionListener(new SelectionAdapter() {
			...
			@Override
			public void widgetSelected(final SelectionEvent e) {
				if (!Dialogs.question("Revert to default",
