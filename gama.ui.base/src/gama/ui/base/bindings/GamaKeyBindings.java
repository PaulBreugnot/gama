/*******************************************************************************************************
 *
 * GamaKeyBindings.java, in gama.ui.base, is part of the source code of the GAMA modeling and simulation platform
 * (v.2.0.0).
 *
...
public class GamaKeyBindings implements Listener {
	...
	public void handleEvent(final Event event) {
		if (event.keyCode == SWT.ESC) {
			if (GAMA.getGui().toggleFullScreenMode()) { consume(event); }
			return;
		}
